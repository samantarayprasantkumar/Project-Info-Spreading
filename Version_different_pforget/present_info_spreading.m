...
dlmwrite([folder '/pforget.txt'],pforget(NR_P_FORGET),'delimiter',' ','-append');
dlmwrite([folder '/ignorants.txt'],ignorants,'delimiter',' ','-append');
dlmwrite([folder '/spreaders.txt'],spreaders,'delimiter',' ','-append');
dlmwrite([folder '/stiflers.txt'],stiflers,'delimiter',' ','-append');
